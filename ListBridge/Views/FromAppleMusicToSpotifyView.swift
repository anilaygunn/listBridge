//
//  FromAppleMusicToSpotifyView.swift
//  ListBridge
//
...
struct FromAppleMusicToSpotifyView: View {
            ...
            VStack(spacing: 24) {
                VStack(spacing: 12) {
                    HStack(spacing: 16) {
                        Image(systemName: "apple.logo")
                            ...
                            .foregroundColor(Color(red: 0.98, green: 0.26, blue: 0.4))
                    }
                ...
                VStack(spacing: 20) {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        TextField("Paste Apple Music playlist URL here", text: $playlistURL)
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Button(action: {
                            ...
                            HStack {
                                ...
                                Text("Show My Apple Music Playlists")
                            }
                            .frame(maxWidth: .infinity)
                            .padding()
                            .background(Color(red: 0.98, green: 0.26, blue: 0.4))
                            .foregroundColor(.white)
                            .cornerRadius(12)
                        }
                    }
